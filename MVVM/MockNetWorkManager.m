...
- (NSArray *)loadData
{
  ...
  @{@"name":@"我的内容",@"content":@"成立于1856年的标志性英国奢侈品牌"},
...
- (NSArray *)loadMoreData
{
  ...
  @{@"name":@"我的内容",@"content":@"近日，国外媒体率先曝光了新一代奥迪A4车型的测试谍照。据  悉，新一代奥迪A4车型将在明年开始正式发售。从已经曝光的测试谍照上我们可以发现，新一代奥迪A4车型将  采用奥迪公司最新的设计理念，造型别致且技术先进的LED头灯将与霸气的中网完美的结合，使得该车型更加动  感"},
